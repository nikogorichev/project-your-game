      ...
      <div className={styles.vse}>
        ...
        <div className={styles.qu}>
          <div className={styles.theme}>
            {cards
              .filter((el) => el.id_theme === 1)
              .map((el) => (
                <QuestionPole key={el.id} card={el} />
              ))}
          </div>
          <div className={styles.theme}>
            {cards
              .filter((el) => el.id_theme === 2)
              .map((el) => (
                <QuestionPole key={el.id} card={el} />
              ))}
          </div>
